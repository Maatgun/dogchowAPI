...
router.post('/', [validarJwt_1.default, validarVerificado_1.isVerified, (0, express_validator_1.check)("price,", "El precio es obligatorio").not().isEmpty(),
    (0, express_validator_1.check)("shippingCost", "El costo del envío es obligatorio").not().isEmpty(),
